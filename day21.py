lines = open('input_day21.txt').read().strip().split('\n')
...
for t in range(19):
    ...
    new_blocks = []
    for r in range(int(n/block_size)):
        block_row = []
        for c in range(int(n/block_size)):
    ...
    def from_block(r,c):
        ...
        return new_blocks[int(r0)][int(c0)][int(r1)][int(c1)]
