...
def reverse_sublist(l, a, b):
    if a <= b:
        ...
        r = (l[a:] + l[:b])[::-1]; l[a:], l[:b] = r[:len(l) - a], r[-b or len(r):]
    return l
...
def knothash_list(day14_input, n=256, g=16, rounds=64, suffix=[17, 31, 73, 47, 23], pos=0, skip=0):
    elems, lengths = [*range(n)], [ord(c) for c in day14_input.strip()] + suffix
