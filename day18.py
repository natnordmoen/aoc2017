...
def run(programs):
    ...
    queues = [deque() for _ in range(programs)]
    times_sent = [0 for _ in range(programs)]
    terminated = [False for _ in range(programs)]
    waiting = [False for _ in range(programs)]
    i = [0 for _ in range(programs)]
